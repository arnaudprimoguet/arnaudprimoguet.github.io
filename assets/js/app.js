...
function scrollToAnchor(aid) {
  event.preventDefault();
  var aTag = jquery__WEBPACK_IMPORTED_MODULE_0___default()("a[name='" + aid + "']");
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('html,body').animate({
    scrollTop: aTag.offset().top
  }, 'slow');
}

jquery__WEBPACK_IMPORTED_MODULE_0___default()("#scrolltoform").click(function () {
  scrollToAnchor('form');
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()("form.form").submit(function () {
  event.preventDefault();
  var formname = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('id');

  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + formname + ' .alert').is(':visible')) {
    return false;
  }

  var gdpr;
  var form = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#" + formname + " input#formname").val();
  var fname = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#" + formname + " input#fname").val();
  var lname = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#" + formname + " input#lname").val();
  var company = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#" + formname + " input#company").val();
  var jobtitle = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#" + formname + " input#jobtitle").val();
  var email = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#" + formname + " input#email").val();
  var phone = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#" + formname + " input#phone").val();
  var country = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#" + formname + " input#country").val();

  if (formname == "callback_form") {
    var message = "A member of the team will be in contact shortly.";

    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("#" + formname + " input#gdpr").is(':checked')) {
      gdpr = "Yes";
    } else {
      gdpr = "No";
    }
  } else {
    var message = "Your content will download shortly.";

    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("#" + formname + " input#gdprdownload").is(':checked')) {
      gdpr = "Yes";
    } else {
      gdpr = "No";
    }
  ...
  var dataString = 'form=' + form + '&fname=' + fname + '&lname=' + lname + '&company=' + company + '&jobtitle=' + jobtitle + '&job=' + email + '&email=' + email + '&phone=' + phone + '&country=' + country + '&gdpr=' + gdpr; //   alert (dataString);return false;

  jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
    type: "POST",
    url: "assets/components/submit.php",
    data: dataString,
    success: function success() {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + formname).html("<div id='message' class='centered message_" + formname + "'></div>");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.message_' + formname).html("<h3>Thank you for providing your details.</h3>").append("<p>" + message + "</p>").hide().fadeIn(1500, function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#message');
      });
      var messages = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.centered').length;

      if (messages == 2) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.centered').removeClass('centered');
      }

      if (formname == 'download_form') {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#download_button").trigger('click');
      } // $('#form .grid-x').addClass('align-middle');
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\netappflash.local\src\assets\js\app.js */"./src/assets/js/app.js");
